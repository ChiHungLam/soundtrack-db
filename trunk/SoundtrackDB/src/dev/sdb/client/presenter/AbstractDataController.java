...
import dev.sdb.client.view.desktop.search.SearchEventHandler;
...
public abstract class AbstractDataController implements ContentPresenter {
	...
	public AbstractDataController(ClientFactory clientFactory, ContentPresenterType type, Flavor flavor) {
		super();
	...
	private DetailView getDetailWidget(long id) {
		assert (id > 0);
